...
# CH32V003 RISC-V Develompent board
This development board features the CH32V003F4U6, an affordable 32-bit RISC-V microcontroller that requires minimal components.

<img src="/images/3D_front.png" alt="Logo">
<img src="/images/3D_front 2.png" alt="Logo">
<img src="/images/3D_front 3.png" alt="Logo">
...
## Power Consumption
The average current consumption of the Development board is about 4mA at 3.6V, as measured with the [Power Profiler Kit II](https://www.nordicsemi.com/Products/Development-hardware/Power-Profiler-Kit-2).

<img src="/PPK2.jpg" alt="Logo" width="500" height="500">



## Building Instructions
1. Re-Make the project and create the Gerber files and upload them to a PCB (printed circuit board) manufacturer of your choice (e.g., [JLCPCB](https://jlcpcb.com/)). They will use these files to create the circuit board for your device and send it to you.
...
![CH32V003_wch-linke.jpg](/WCH_LinkE.webp)
...
Connect the Development board via the 3-pin PROG header to the programming device. Open a terminal and navigate to the folder with the *makefile*. Run the following command to compile and upload:
```
make flash
```
